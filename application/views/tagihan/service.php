<div class="multisteps-form__content">
	<div class="row">
		<div class="col-6 col-sm-6">
			...
			<div class="form-group row">
				<label class="col-4 col-sm-4 text-left">Luas</label>
				<input type="text" class="form-control col-8 col-sm-8" aria-describedby="textHelp" placeholder="" readonly>
				<small id="textHelp" class="form-text text-muted"></small>
			</div>
			<div class="form-group row">
				<label class="col-4 col-sm-4 text-left">Total Luas</label>
				<input type="text" class="form-control col-8 col-sm-8" aria-describedby="textHelp" placeholder="" readonly>
				<small id="textHelp" class="form-text text-muted"></small>
			</div>
		</div>
		<div class="col-6 col-sm-6">
			<div class="form-group row">
				<label class="col-4 col-sm-4 text-left">Nominal Service Charge</label>
				<input type="text" class="form-control col-8 col-sm-8" aria-describedby="textHelp" placeholder="" readonly>
				<small id="textHelp" class="form-text text-muted"></small>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<label class="col-4 col-sm-4 text-left">Persentase PPN</label>
				<input type="text" class="form-control col-8 col-sm-8" aria-describedby="textHelp" placeholder="" readonly>
				<small id="textHelp" class="form-text text-muted"></small>
			</div>
			<div class="form-group row">
				<label class="col-4 col-sm-4 text-left">Nominal PPN</label>
				<input type="text" class="form-control col-8 col-sm-8" aria-describedby="textHelp" placeholder="" readonly>
				<small id="textHelp" class="form-text text-muted"></small>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<label class="col-4 col-sm-4 text-left">Total Service Charge</label>
				<input type="text" class="form-control col-8 col-sm-8" aria-describedby="textHelp" placeholder="" readonly>
				<small id="textHelp" class="form-text text-muted"></small>
			</div>
		</div>
