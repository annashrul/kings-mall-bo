		...
		<div class="container-fluid">
			<div class="row align-items-center">
				<div class="col-6">
					<div class="dashboard-header-title mb-3">
						...
						<p class="mb-0 font-weight-bold">Welcome to Motrila Dashboard.</p>
					</div>
				</div>
				<!-- Dashboard Info Area -->
				<div class="col-6">
			...
			<div class="row">
					...
					<div class="card bg-primary earning-date">
						<div class="card-body">
							<div class="dashboard-tab-area">
								<h5 class="text-white card-title">Earnings</h5>
								<div class="bd-example bd-example-tabs">
										...
										<div class="tab-pane fade" id="earnings-mon" role="tabpanel" aria-labelledby="pills-earnings-mon">
											<div class="d-flex align-items-center justify-content-between">
												<div>
													...
													<span class="text-white mb-3 d-block">TOTAL EARNINGS</span>
												</div>
									...
									<ul class="nav nav-pills align-items-center" id="pills-tab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active show" id="pills-earnings-sat" data-toggle="pill" href="#earnings-sat" role="tab" aria-controls="earnings-sat" aria-selected="false">Sat</a>
										</li>
										<li class="nav-item">
											<a class="nav-link show" id="pills-earnings-sun" data-toggle="pill" href="#earnings-sun" role="tab" aria-controls="earnings-sun" aria-selected="true">Sun</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" id="pills-earnings-mon" data-toggle="pill" href="#earnings-mon" role="tab" aria-controls="earnings-mon" aria-selected="false">Mon</a>
										</li>
										<li class="nav-item">
											<a class="nav-link show" id="pills-earnings-tue" data-toggle="pill" href="#earnings-tue" role="tab" aria-controls="earnings-tue" aria-selected="false">Tue</a>
										</li>
										<li class="nav-item">
											<a class="nav-link show" id="pills-earnings-wed" data-toggle="pill" href="#earnings-wed" role="tab" aria-controls="earnings-wed" aria-selected="false">Wed</a>
										</li>
										<li class="nav-item">
											<a class="nav-link show" id="pills-earnings-thu" data-toggle="pill" href="#earnings-thu" role="tab" aria-controls="earnings-thu" aria-selected="false">Thu</a>
										</li>
										<li class="nav-item">
											<a class="nav-link show" id="pills-earnings-fri" data-toggle="pill" href="#earnings-fri" role="tab" aria-controls="earnings-fri" aria-selected="false">Fri</a>
										</li>
									</ul>
								</div>
				...
				<div class="col-md-6 height-card box-margin">
					<div class="card">
						<div class="card-body">
							<h5 class="font-20 mb-1">Congratulations Himla!</h5>
							<p class="mb-20">Best seller of the month</p>
							<div class="d-flex justify-content-between align-items-center">
								<div class="dashboard-content-right">
									<h2 class="text-success font-36 font-weight-bold">$59k</h2>
									<p class="font-15 font-weight-bold">You have done 65.6% more <br>sales today.</p>
									<button type="button" class="btn btn-primary mt-15">View Sales</button>
								</div>
								<div class="dashboard-content-left wow shake" data-wow-delay="0.6s">
									<img src="img/bg-img/5.jpg" class="img-fluid" alt="Dashboard" width="180" height="180">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card  bg-c-blue">
						<div class="card-body">
							...
							<div class="earning-text mb-4">
								<h3 class="mb-3">$ 295.36 <i class="feather icon-arrow-up teal accent-3"></i></h3>
								<span class="text-uppercase d-block">Earnings</span>
							</div>
						...
						<div class="card-body py-4">
							<div class="media align-items-center">
								...
								<div class="media-body">
									...
									<div class="mb-0 font-14 font-weight-bold">Sales Today</div>
								</div>
						...
						<div class="card-body py-4">
							<div class="media align-items-center">
								...
								<div class="media-body">
									...
									<div class="mb-0 font-14 font-weight-bold">Visitors Today</div>
								</div>
						...
						<div class="card-body py-4">
							<div class="media align-items-center">
								...
								<div class="media-body">
									...
									<div class="mb-0 font-14 font-weight-bold">Total Revenue</div>
								</div>
								<div class="pity-chart">
							...
							<div class="client-name">
								<div class="row">
									<div class="col-sm-12 pt-2 pb-2">
										<span class="mr-3 font-weight-bold">Main wallet</span>
										<span class="float-right font-weight-bold">$194.42</span>
									</div>
									<div class="col-sm-12 pt-2 pb-2">
										<span class="mr-3 font-weight-bold">Travel</span>
										<span class="float-right font-weight-bold">$86.48</span>
									</div>
									<div class="col-sm-12 pt-2">
										<span class="mr-3 font-weight-bold">Food &amp; Drink</span>
										<span class="float-right font-weight-bold">$23.27</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-body">
							...
							<div class="row pb-3">
								<div class="col-md-4 col-6 text-center">
									<h5 class="f-w-300">$ 2569.4</h5>
									<span>Invoiced</span>
								</div>
								<div class="col-md-4 col-6 text-center">
									<h5 class="f-w-300">$ 3569.6</h5>
									<span>Profit</span>
								</div>
								<div class="col-md-4 col-12 text-center">
									<h5 class="f-w-300">$ 356.9</h5>
									<span>Expenses</span>
								</div>
							</div>
							<div id="line-regions" style="height: 300px;"></div>
						</div>
					</div>
				</div>
								...
								<div class="col-12">
									<div class="single-widget-timeline mb-15">
										<div class="media">
											<div class="mr-3">
												<i class="fa fa-circle text-success font-11 mr-2"></i>
												<a href="#!"><img class="rounded-circle" style="width:40px;" src="img/member-img/team-1.jpg" alt="chat-user"></a>
											</div>
											<div class="media-body">
												<h6 class="d-inline-block">The Quick Brown Fox</h6>
								...
								<div class="col-12">
									<div class="single-widget-timeline mb-15">
										<div class="media">
											<div class="mr-3">
												<i class="fa fa-circle text-success font-11 mr-2"></i>
												<a href="#!"><img class="rounded-circle" style="width:40px;" src="img/member-img/team-2.jpg" alt="chat-user"></a>
											</div>
											<div class="media-body">
												<h6 class="d-inline-block">The Quick Brown Fox</h6>
												<p class="mb-0">Lorem Ipsum is simply dummy text…</p>
								...
								<div class="col-12">
									<div class="single-widget-timeline">
										<div class="media">
											<div class="mr-3">
												<i class="fa fa-circle text-success font-11 mr-2"></i>
												<a href="#!"><img class="rounded-circle" style="width:40px;" src="img/member-img/team-4.jpg" alt="chat-user"></a>
											</div>
											<div class="media-body">
												<h6 class="d-inline-block">The Quick Brown Fox</h6>
								...
								<div class="chats" id="chatBox">
									<div class="chats">
										<div class="chat">
											<div class="chat-avatar">
												<a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
													<img src="img/member-img/1.png" alt="avatar" />
												</a>
											</div>
											<div class="chat-body">
												<div class="chat-content">
													<p class="text-white">How can we help? We're here for you!</p>
												</div>
											</div>
										</div>
										<div class="chat chat-left">
											<div class="chat-avatar">
												<a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
													<img src="img/member-img/2.png" alt="avatar" />
												</a>
											</div>
											<div class="chat-body">
												<div class="chat-content">
										...
										<div class="chat">
											<div class="chat-avatar">
												<a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
													<img src="img/member-img/3.png" alt="avatar" />
												</a>
											</div>
											<div class="chat-body">
												<div class="chat-content">
													<p class="text-white">Absolutely!</p>
												</div>
											</div>
										</div>
										<div class="chat chat-left">
											<div class="chat-avatar">
												<a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
													<img src="img/member-img/4.png" alt="avatar" />
												</a>
											</div>
											<div class="chat-body">
												<div class="chat-content">
										...
										<div class="chat">
											<div class="chat-avatar">
												<a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
													<img src="img/member-img/5.png" alt="avatar" />
												</a>
											</div>
											<div class="chat-body">
												<div class="chat-content">
													<p class="text-white">Crest admin is the responsive bootstrap 4 admin template.</p>
												</div>
											</div>
										</div>
										<div class="chat chat-left">
											<div class="chat-avatar">
												<a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
													<img src="img/member-img/6.png" alt="avatar" />
												</a>
											</div>
											<div class="chat-body">
												<div class="chat-content">
									...
									<div class="col-12">
										<fieldset>
											<div class="input-group position-relative has-icon-left">
												<input type="text" class="form-control" placeholder="Send message" aria-describedby="button-addon3">
					...
					<div class="card">
						<div class="card-body pb-0">
							...
							<div class="row mb-3">
								<div class="col-9">
									<div class="progress-wrapper">
										<span class="progress-label text-dark font-weight-bold">Web design</span>
							...
							<div class="row mb-3">
								<div class="col-9">
									<div class="progress-wrapper">
										<span class="progress-label text-dark font-weight-bold">Website Markup</span>
										<div class="progress mt-2 mb-2" style="height: 5px;">
							...
							<div class="row mb-3">
								<div class="col-9">
									<div class="progress-wrapper">
										<span class="progress-label text-dark font-weight-bold">One page</span>
										<div class="progress mt-2 mb-2" style="height: 5px;">
							...
							<div class="row mb-3">
								<div class="col-9">
									<div class="progress-wrapper">
										<span class="progress-label text-dark font-weight-bold">Responsive Template</span>
										<div class="progress mt-2 mb-2" style="height: 5px;">
							...
							<div class="row mb-3">
								<div class="col-9">
									<div class="progress-wrapper">
										<span class="progress-label text-dark font-weight-bold">Mobile Template</span>
										<div class="progress mt-2 mb-2" style="height: 5px;">
							...
							<div class="user-card-body">
								<div class="client-media-content d-flex align-items-center mb-4">
									...
									<div class="user--media-body">
										<h6 class="mb-0 text-dark font-15">Hello Dolly</h6>
								...
								<div class="client-media-content d-flex align-items-center mb-4">
									...
									<div class="user--media-body">
										<h6 class="mb-0 text-dark font-15">John Doe</h6>
								...
								<div class="client-media-content d-flex align-items-center mb-4">
									...
									<div class="user--media-body">
										<h6 class="mb-0 text-dark font-15">Mir Jahan</h6>
								...
								<div class="client-media-content d-flex align-items-center mb-4">
									...
									<div class="user--media-body">
										<h6 class="mb-0 text-dark font-15">Doe Sunil</h6>
										<span class="font-13">doesunil@example.com</span>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-12 box-margin">
					<div class="card code-table">
						<div class="card-body pb-0">
							<h5 class="card-title">Our Project</h5>
							<div class="table-responsive">
								<table class="table table-hover">
									...
									<tr>
										<td>
											<h6 class="mb-1">#367</h6>
										</td>
										<td>
											<h6 class="mb-1">8965482</h6>
										</td>
										<td>
											<h6 class="font-14">Nov 14, 2019</h6>
										</td>
										<td>
											<h6 class="font-14">$7523</h6>
										</td>
									...
									<tr>
										<td>
											<h6 class="mb-1">#366</h6>
										</td>
										<td>
											<h6 class="mb-1">2366482</h6>
										</td>
										<td>
											<h6 class="font-14">Nov 13, 2019</h6>
										</td>
										<td>
											<h6 class="font-14">$2334</h6>
										</td>
									...
									<tr>
										...
										<td>
											<h6 class="font-14">Oct 14, 2019</h6>
										</td>
										<td>
											<h6 class="font-14">$2346</h6>
										</td>
										<td><a href="#!" class="badge badge-success badge-pill">Active</a></td>
										<td class="text-right"><a href="#!"><i class="fa fa-star f-18 text-warning"></i></a>
											<a href="#!"><i class="fa fa-star f-18 text-warning"></i></a>
									...
									<tr>
										<td>
											<h6 class="mb-1">#326</h6>
										</td>
										<td>
											<h6 class="mb-1">9632638</h6>
										</td>
										<td>
											<h6 class="font-14">Dec 17, 2019</h6>
										</td>
										<td>
											<h6 class="font-14">$1346</h6>
										</td>
										<td><a href="#!" class="badge badge-danger badge-pill">Not Active</a></td>
										<td class="text-right"><a href="#!"><i class="fa fa-star f-18 text-warning"></i></a>
											<a href="#!"><i class="fa fa-star f-18 text-black-50"></i></a>
									...
									<tr>
										...
										<td>
											<h6 class="font-14">July 14, 2019</h6>
										</td>
										<td>
											<h6 class="font-14">$3246</h6>
										</td>
										<td><a href="#!" class="badge badge-success badge-pill">Active</a></td>
										<td class="text-right"><a href="#!"><i class="fa fa-star f-18 text-warning"></i></a>
											<a href="#!"><i class="fa fa-star f-18 text-warning"></i></a>
