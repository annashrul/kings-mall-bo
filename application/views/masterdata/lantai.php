...
<div class="main-content">
	<div class="dashboard-area">
		<div class="container-fluid">
			<h4 class="card-title">Tambah Lantai &nbsp; <a href="javascript:void(0)" onclick="showForm('tipe')"><i class="fa fa-plus btn btn-info btn-circle rotate0"></i></a></h4>
			<div class="card mt-3 fadeInUp animated" id="cdList">
				<div class="card-body">
					<h4 class="card-title">List Master Lantai</h4>
					<hr>
					<!-- <div class="col-12"> -->
